...
var wasmBinaryFile;
  wasmBinaryFile = 'Yabal.Wasm.wasm';
...
var ASM_CONSTS = {
  ...
  err('missing function: Halt'); abort(-1);
  }

  /** @type {function(...*):?} */
  function _ShowVariable(
  ) {
  err('missing function: ShowVariable'); abort(-1);
  }
...
/** @type {function(...*):?} */
var _Compile = Module["_Compile"] = createExportWrapper("Compile");
...
var ___Module__DATA = Module['___Module__DATA'] = 1356544;
